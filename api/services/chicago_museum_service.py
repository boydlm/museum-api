...
class ChicagoMuseumService(MuseumService):
    ...
    def make_exhibitions_from_api_response(self, api_response: str ="") -> list[dict]:
        ...
        for exhibition in exhibition_response:
            new_exhibition = create_exhibition_dict(exhibition["title"], exhibition["short_description"], exhibition["aic_start_at"], exhibition["aic_end_at"], exhibition["web_url"], exhibition["image_url"])
